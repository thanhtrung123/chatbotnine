...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function overrideConfig($src, $dest)
        {
                        /** @var \App\Services\UtilService $instance */
                        return $instance->overrideConfig($src, $dest);
        }
                    /**
         * CSV関連ルート追加
         *
         ...
         * @static 
         */ 
        public static function addCsvRoute($name, $controller = null, $only = [])
        {
                        /** @var \App\Services\UtilService $instance */
                        return $instance->addCsvRoute($name, $controller, $only);
        }
                    /**
         * 実行時間測定開始
         *
         ...
         * @static 
         */ 
        public static function execTimeStart($name)
        {
                        /** @var \App\Services\UtilService $instance */
                        return $instance->execTimeStart($name);
        }
                    /**
         * 実行時間測定停止
         *
         ...
         * @static 
         */ 
        public static function execTimeStop($name)
        {
                        /** @var \App\Services\UtilService $instance */
                        return $instance->execTimeStop($name);
        }
                    /**
         * 実行時間取得
         *
         ...
         * @static 
         */ 
        public static function getWeekAry($base_week, $week_num)
        {
                        /** @var \App\Services\UtilService $instance */
                        return $instance->getWeekAry($base_week, $week_num);
        }
                    /**
         * メモリ使用量をログに出力
         *
         ...
         * @static 
         */ 
        public static function createChoice($db_data, $key_col, $val_col)
        {
                        /** @var \App\Services\UtilService $instance */
                        return $instance->createChoice($db_data, $key_col, $val_col);
        }
                    /**
         * 学習データ→QaAry
         *
         ...
         * @static 
         */ 
        public static function learningDataToQaAry($learning_data)
        {
                        /** @var \App\Services\UtilService $instance */
                        return $instance->learningDataToQaAry($learning_data);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getCustomErrorMessage($code, $code_const_path, $message_path, $default = null)
        {
                        /** @var \App\Services\UtilService $instance */
                        return $instance->getCustomErrorMessage($code, $code_const_path, $message_path, $default);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getConstArray($const, $key_only = false, $option = [])
        {
                        /** @var \App\Services\ConstService $instance */
                        return $instance->getConstArray($const, $key_only, $option);
        }
                    /**
         * 定数IDから名前を取得
         *
         ...
         * @static 
         */ 
        public static function getConstName($id, $const)
        {
                        /** @var \App\Services\ConstService $instance */
                        return $instance->getConstName($id, $const);
        }
...
namespace  { 
            ...
            class Util extends \App\Facades\UtilFacade {}
            class Constant extends \App\Facades\ConstFacade {}
