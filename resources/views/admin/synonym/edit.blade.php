...
@section('pageTitle',  __('admin.header.synonym_data').__('admin.edit'))
@section('content')
<div class="container">
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-10">
                                    {{ Form::open(['url'=>route('admin.synonym.update',['user'=>$id]),'method'=>'PUT','class'=>'form-horizontal','id'=>'entry_form']) }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a class="btn btn-default btn-block" href="{{ route('admin.synonym.index',['r'=>1]) }}">{{__('admin.cancel')}}</a>
                                        </div>
                                    </div>
