                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            {{__('admin.proper_noun.問題ございません。<br/>このまま、固有名詞データを更新される場合、<br/>以下の登録ボタンをクリックしてください。')}}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4"></div>
                                        <div class="col-md-2">
                                            <a class="btn btn-warning btn-block" href="{{ route('admin.proper_noun.import') }}">{{__('admin.キャンセル')}}</a>
                                        </div>
                                        <div class="col-md-2">
