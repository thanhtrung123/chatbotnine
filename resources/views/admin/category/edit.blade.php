                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    {{ Form::form_text('name','カテゴリ名',true,['required'=>true,'autofocus'=>true]) }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a class="btn btn-default btn-block" href="{{ route('admin.category.index',['r'=>1]) }}">戻る</a>
                                        </div>
                                    </div>
